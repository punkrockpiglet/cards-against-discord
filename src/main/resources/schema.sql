...
alter table games add constraint fk_judge_id foreign key (judge_id) references players (id);
alter table games add constraint fk_black_card_id foreign key (black_card_id) references black_cards (id);

alter table players add constraint fk_game_id foreign key (game_id) references games (id);
alter table players add constraint fk_selected_white_card_id foreign key (selected_white_card_id) references white_cards (id);

alter table player_cards add constraint uc_player_white_card unique (player_id, white_card_id);
alter table player_cards add constraint fk_player_id foreign key (player_id) references players (id);
alter table player_cards add constraint fk_white_card foreign key (white_card_id) references white_cards (id);

alter table picked_cards add constraint fk_player_id foreign key (player_id) references players (id);
alter table picked_cards add constraint fk_white_card foreign key (white_card_id) references white_cards (id);